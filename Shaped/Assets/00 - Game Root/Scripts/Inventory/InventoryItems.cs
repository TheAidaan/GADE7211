...
public class InventoryItems //all the inventory items
{
    public static InventoryItem Circle = new InventoryItem(4,"Circle", "Circle");
    public static InventoryItem Hexagon = new InventoryItem(11,"Hexagon", "Circle");
    public static InventoryItem Triangle = new InventoryItem(2,"Triagle", "Circle");
}
